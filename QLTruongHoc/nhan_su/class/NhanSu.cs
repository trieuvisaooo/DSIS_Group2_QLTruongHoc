...
namespace QLTruongHoc.nhan_su
{
    public class NhanSu
    {
        ...
        public void getEmpInfo(int mans)
        {
            ...
            {
                query_sql = "SELECT TO_CHAR(MANS), HOTEN, PHAI, TO_CHAR(NGSINH), DIACHI, DT, TO_CHAR(PHUCAP), VAITRO, MADV, MACS FROM QLTH.QLTH_NHANSU WHERE MANS = " + mans;
            }
