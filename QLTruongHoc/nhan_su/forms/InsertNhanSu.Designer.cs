namespace QLTruongHoc.nhan_su.forms
{
    partial class InsertNhanSu
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBox2.Items.AddRange(new object[] { "Nhân viên cơ bản", "Giảng viên", "Giáo vụ", "Trưởng đơn vị" });
            ...
            label7.Location = new Point(139, 372);
            ...
            comboBox3.Items.AddRange(new object[] { "VPK", "HTTT", "KHMT", "CNPM", "CNTT", "TGMT", "MMT" });
            comboBox3.Location = new Point(210, 438);
