...
GRANT SELECT, INSERT, DELETE, UPDATE ON QLTH.QLTH_PHANCONG TO RL_QLTH_GIAOVU;
--GRANT UPDATE ON QLTH.QLTH_PHANCONG TO RL_QLTH_GIAOVU;
--GRANT DELETE ON QLTH.QLTH_PHANCONG TO RL_QLTH_GIAOVU;

-- Xóa hoặc thêm dòng trên quan hệ ĐANGKY theo yêu cầu của sinh viên trong khoảng thời gian còn cho hiệu chỉnh đăng ký
GRANT INSERT, DELETE ON QLTH.QLTH_DANGKY TO RL_QLTH_GIAOVU;
...
CREATE OR REPLACE VIEW QLTH.UV_QLTH_KEHOACHMOHP AS
    SELECT KHM.MAHP, KHM.HK, KHM.NAM, KHM.MACT, PC.NGAYHOC, PC.TIET, HP.TENHP, HP.SOTC, HP.STLT, HP.STTH, HP.SOSVTD, PC.SOSVDK, HP.MADV
...
/
--------------------------------------------------------------------------------
-- BỔ SUNG: VIEW BỔ SUNG HỖ TRỢ CÀI ĐẶT APP
--------------------------------------------------------------------------------
-- Nhân viên
...
-- Giáo vụ
GRANT SELECT ON QLTH.QLTH_THOIGIANDK TO RL_QLTH_GIAOVU;
GRANT SELECT ON QLTH.UV_QLTH_KEHOACHMOHP TO RL_QLTH_GIAOVU;
GRANT DELETE ON QLTH.QLTH_KHMO TO RL_QLTH_GIAOVU;
